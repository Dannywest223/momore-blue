...
const categories = [
  {
    name: "Clothing",
    image: clothingImg, // using your 99.jpg
  ...
  {
    name: "Homeware",
    image: homewareImg, // using your 98.jpg
...
const CategorySection = () => {
  ...
  src={category.image}
  alt={category.name}
  className="w-full h-64 object-contain bg-white transition-transform duration-700 group-hover:scale-105"
/>
